...
/**
 * Manager-created agent: a new agent user plus an approved KYC profile in one
 * step. Field set and rules mirror the mini app application form
 * (Agent\StoreAgentProfileRequest) so both entry points stay in sync.
 */
class StoreAgentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // KYC scans — must reference files the manager uploaded themselves.
    ...
    /**
     * Rule enforcing the file belongs to the requesting manager.
     */
